...
describe("getIntegrationDetails", () => {
  ...
  test("returns correct details for googleSheets integration", () => {
    ...
    expect(details).toEqual({
      ...
      docsLink: "https://survey.medascloud.com/docs/integrations/google-sheets",
  ...
  test("returns correct details for airtable integration", () => {
    ...
    expect(details).toEqual({
      ...
      docsLink: "https://survey.medascloud.com/docs/integrations/airtable",
  ...
  test("returns correct details for notion integration", () => {
    ...
    expect(details).toEqual({
      ...
      docsLink: "https://survey.medascloud.com/docs/integrations/notion",
  ...
  test("returns correct details for slack integration", () => {
    ...
    expect(details).toEqual({
      ...
      docsLink: "https://survey.medascloud.com/docs/integrations/slack",
