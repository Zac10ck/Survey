      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        {webhook.secret && (
          <div className="col-span-1">
            ...
            <Link
              href="https://survey.medascloud.com/docs/xm-and-surveys/core-features/integrations/webhooks#webhook-security-with-standard-webhooks"
              target="_blank"
        ...
        <div className="flex justify-between space-x-2">
          <div className="flex space-x-2">
            ...
            <Button variant="secondary" asChild>
              <Link href="https://survey.medascloud.com/docs/api/management/webhooks" target="_blank">
                {t("common.read_docs")}
              </Link>
            </Button>
          </div>
