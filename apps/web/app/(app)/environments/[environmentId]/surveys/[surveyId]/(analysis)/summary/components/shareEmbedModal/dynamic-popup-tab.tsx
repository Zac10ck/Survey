        ...
        links={[
          {
            ...
            href: "https://survey.medascloud.com/docs/xm-and-surveys/surveys/website-app-surveys/advanced-targeting",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.code_no_code_triggers"),
            href: "https://survey.medascloud.com/docs/xm-and-surveys/surveys/website-app-surveys/actions",
          },
          {
            title: t("environments.surveys.share.dynamic_popup.recontact_options"),
            href: "https://survey.medascloud.com/docs/xm-and-surveys/surveys/website-app-surveys/recontact",
          },
        ]}
      />
    </div>
